...
if not defined UNITY if exist "%ProgramFiles%\Unity\Hub\Editor\6000.6.0f1\Editor\Unity.exe" set "UNITY=%ProgramFiles%\Unity\Hub\Editor\6000.6.0f1\Editor\Unity.exe"
